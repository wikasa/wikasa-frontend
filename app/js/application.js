 ...
 * wikasa
 * 
 * @author bangsawan & rianti
 * @version 0.0.0
 * Copyright . Free licensed.
 */
/*!
...
;( function( window ) {
    ...
    function UISearch( el, options ) {
        this.el = el;
        this.inputEl = el.querySelector( 'form > input.sch-input' );
        this._initEvents();
    }
        ...
        _initEvents : function() {
            var self = this,
                initSearchFn = function( ev ) {
                    ...
                    if( !classie.has( self.el, 'open' ) ) { // open it
                        ev.preventDefault();
                        self.open();
                    }
                    else if( classie.has( self.el, 'open' ) && /^\s*$/.test( self.inputEl.value ) ) { // close it
                        ev.preventDefault();
                        self.close();
                    }
                }
    ...
    new UISearch( document.getElementById( 'sch' ) );
